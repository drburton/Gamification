                                              ...
                                              foreach ($doc as $k => $v) { //Filter out keys from key-value pairs in the returned array
                                                ...
                                                $desc = str_replace(" ","_",$desc);
	                                              ...
	                                              if(!in_array($dbid, $curQuests)){
	                                              	...
	                                              	print "<td><a href=\"#\"><button class=\"btn btn-success btn-sm\" data-toggle=\"modal\" data-target=\"#acceptquest\" data-course=$course_under data-id=$dbid data-title = $title>Accept Quest</button></a></td>";
	                                              	print "</tr>";
	                                          	  }
                                              }
                                           ?>
